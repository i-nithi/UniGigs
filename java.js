...
(function () {
    ...
    const SEED_USERS = [
        {
            id: 'usr_1',
            name: 'Rahul Sharma',
            email: 'rahul.cs22@iitd.ac.in',
            password: 'password123',
            dept: 'Computer Science & Engineering',
            year: '3rd Year (Junior)',
            campus: 'IIT Delhi Campus',
            bio: 'Final year CS undergrad passionate about mobile dev and UI design. Available for lab setup help, printing runs around Block B, and coding tutoring.',
            skills: ['Python & C++', 'Fast Delivery', 'Linear Algebra', 'DSLR Photography'],
            avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=200&q=80',
            walletBalance: 1200,
            pendingEscrow: 650,
            totalEarned: 4250,
        ...
        },
        {
            id: 'usr_2',
            name: 'Ananya Sen',
            email: 'ananya.math23@iitd.ac.in',
            password: 'password123',
            dept: 'Mathematics & Computing',
            year: '2nd Year',
            campus: 'IIT Delhi Campus',
            bio: 'Math enthusiast. Love solving calculus problems, tutoring for mid-terms, and managing event logistics.',
            skills: ['Calculus & Algebra', 'Event Management', 'LaTeX Formatting'],
            avatar: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=200&q=80',
            walletBalance: 850,
            pendingEscrow: 450,
    ...
    const SEED_MESSAGES = [
        {
            ...
            senderId: 'usr_3',
            receiverId: 'usr_1',
            text: 'Hey Rahul! Did you manage to get the biryani from Canteen 2?',
            timestamp: '2026-08-29T21:10:00Z',
            isRead: true
        },
        {
    ...
    const SEED_REVIEWS = [
        {
            ...
            rating: 5,
            date: '28 Aug 2026',
            text: 'Rahul was extremely punctual and handled moving the heavy study table carefully. Highly recommended worker!'
        },
        {
            id: 'rev_2',
            targetUserId: 'usr_1',
    ...
    function renderProfile() {
        ...
        document.getElementById('profile-page-name').textContent = user.name;
        document.getElementById('profile-page-dept').textContent = `${user.dept} • ${user.year}`;
        document.getElementById('profile-page-campus').innerHTML = `<i class="ri-building-4-line"></i> ${user.campus || 'IIT Delhi Campus'}`;
        document.getElementById('profile-page-avatar').src = user.avatar;
        document.getElementById('profile-page-rating').textContent = `${user.rating} ★`;
        document.getElementById('profile-page-completed').textContent = user.completedGigsCount;
        document.getElementById('profile-page-earned').textContent = `₹${user.totalEarned}`;
    ...
    function bindGlobalEvents() {
        ...
        // Demo login shortcuts
        document.getElementById('demo-user-1')?.addEventListener('click', () => {
            document.getElementById('login-email').value = 'rahul.cs22@iitd.ac.in';
            document.getElementById('login-password').value = 'password123';
        });

        document.getElementById('demo-user-2')?.addEventListener('click', () => {
            document.getElementById('login-email').value = 'ananya.math23@iitd.ac.in';
            document.getElementById('login-password').value = 'password123';
        });
...
>>>>>>> ac9649f38eca4e41c0d6149c2a42634ef0fc7e30
