...
(function () {
    ...
    const SEED_GIGS = [
        ...
        {
            id: 'gig_9',
            title: 'Convert Handwritten Organic Chemistry Notes into Formatted PDF',
            category: 'Academic Help',
            description: 'Scan 15 handwritten pages of reaction mechanisms and type neat notes with formulas into Word/PDF document before tomorrow.',
            reward: 320,
            location: 'Science Block A',
            deadline: '2026-08-30T20:00',
            postedBy: 'usr_2',
            assignedWorker: null,
            status: 'available',
            submissionDetails: null,
            requirements: ['Neat formatting', 'Deliver PDF via Drive'],
            requiredSkills: ['LaTeX Formatting', 'Fast Delivery', 'Linear Algebra'],
        ...
        {
            id: 'gig_10',
            title: 'Pick Up Lab Coat & Safety Goggles from Chemistry Store',
            category: 'Errands',
            description: 'Collect reserved lab coat size L and safety goggles from Department Store near Science Block and hand over at Lab 2 entrance.',
            reward: 150,
            location: 'Science Block A',
            deadline: '2026-08-30T14:00',
            postedBy: 'usr_4',
            assignedWorker: null,
            status: 'available',
            submissionDetails: null,
            requirements: ['Punctual delivery before 2 PM lab'],
            requiredSkills: ['Campus Errands', 'Fast Delivery'],
        ...
        {
            id: 'gig_11',
            title: 'Canteen Fresh Fruit Juice & Sandwich Delivery to CS Lab 3',
            category: 'Food',
            description: 'Need 2 Mango Smoothies + 2 Grilled Cheese Sandwiches picked up from Canopy Cafe and delivered to Tech Park CS Lab 3.',
            reward: 160,
            location: 'Tech Park & Computer Labs',
            deadline: '2026-08-30T16:00',
            postedBy: 'usr_3',
            assignedWorker: null,
            status: 'available',
            submissionDetails: null,
            requirements: ['Deliver hot/fresh'],
            requiredSkills: ['Fast Delivery', 'Campus Errands'],
            estimatedDuration: '20 mins',
        ...
        {
            id: 'gig_12',
            title: 'Color Print & Staples for 40-Page Mini-Project Report',
            category: 'Printing',
            description: 'Print 40 double-sided color pages of software design documentation, staple top left corner, and drop off at Central Library.',
            reward: 190,
            location: 'Central Library & Reading Hall',
            deadline: '2026-08-30T17:30',
            postedBy: 'usr_2',
            assignedWorker: null,
            status: 'available',
            submissionDetails: null,
            requirements: ['High quality color print'],
            requiredSkills: ['Printer Access', 'Fast Delivery'],
            estimatedDuration: '30 mins',
        ...
        {
            id: 'gig_13',
            title: 'Help Fix HTML/CSS Layout Alignment on React Portfolio Web Page',
            category: 'Technical Help',
            description: 'Experiencing flexbox overlapping issues on mobile viewport in my personal portfolio website. Need 45 mins guidance from a web dev.',
            reward: 380,
            location: 'Tech Park & Computer Labs',
            deadline: '2026-08-30T21:00',
            postedBy: 'usr_4',
            assignedWorker: null,
            status: 'available',
            submissionDetails: null,
            requirements: ['Experience with CSS Flexbox & Grid'],
            requiredSkills: ['Web Development', 'Python & C++'],
            estimatedDuration: '45 mins',
